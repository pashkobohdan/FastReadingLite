...
import static com.pashkobohdan.fastreadinglite.library.bookTextWorker.BookInfo.BOOKS_COLOR_PREFERENCE_NAME;
import static com.pashkobohdan.fastreadinglite.library.bookTextWorker.BookInfo.BOOKS_CURRENT_SPEED_PREFERENCE_NAME;
...
public class BookInfoFactory {
    ...
    public static BookInfo newInstance(File file, Activity activity) {
        ...
        bookInfo.setCurrentSpeed(bookInfo.getBookSpeedsPreferences().getInt(bookInfo.getFileName(), 260));
